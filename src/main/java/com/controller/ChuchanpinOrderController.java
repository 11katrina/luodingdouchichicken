...
public class ChuchanpinOrderController {
    private static final Logger logger = LoggerFactory.getLogger(ChuchanpinOrderController.class);
    ...
    @Autowired
    private NongchanpinService nongchanpinService;//畜产品
    @Autowired
...
//                            nongchanpinOrderEntity.setNongchanpinId(Integer.valueOf(data.get(0)));   //畜产品 要改的
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        for (Map<String, Object> map : nongchanpins) {
           //取值
            ...
            nongchanpinOrderEntity.setNongchanpinId(nongchanpinId);//畜产品
    ...
    */
    ...
    public R refund(Integer id, HttpServletRequest request){
        ...
        String role = String.valueOf(request.getSession().getAttribute("role"));
            ...
            nongchanpinService.updateById(nongchanpinEntity);//更新订单中畜产品的信息
