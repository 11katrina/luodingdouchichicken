...
public class ChuchanpinController {
    private static final Logger logger = LoggerFactory.getLogger(ChuchanpinController.class);
    ...
    @Autowired
    private NongchanpinCollectionService nongchanpinCollectionService;//畜产品收藏
    @Autowired
    private NongchanpinCommentbackService nongchanpinCommentbackService;//畜产品评价
    @Autowired
    private NongchanpinOrderService nongchanpinOrderService;//畜产品订单
    @Autowired
...
//                            nongchanpinEntity.setNongchanpinName(data.get(0));                    //畜产品名称 要改的
//                            nongchanpinEntity.setNongchanpinPhoto("");//详情和图片
//                            nongchanpinEntity.setNongchanpinTypes(Integer.valueOf(data.get(0)));   //畜产品类型 要改的
//                            nongchanpinEntity.setNongchanpinKucunNumber(Integer.valueOf(data.get(0)));   //畜产品库存 要改的
//                            nongchanpinEntity.setNongchanpinOldMoney(data.get(0));                    //畜产品原价 要改的
