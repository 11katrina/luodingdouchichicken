...
public class ChuchanpinCollectionController {
    private static final Logger logger = LoggerFactory.getLogger(ChuchanpinCollectionController.class);
...
//                            nongchanpinCollectionEntity.setNongchanpinId(Integer.valueOf(data.get(0)));   //畜产品 要改的
