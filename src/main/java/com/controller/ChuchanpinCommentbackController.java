...
public class ChuchanpinCommentbackController {
    private static final Logger logger = LoggerFactory.getLogger(ChuchanpinCommentbackController.class);
...
//                            nongchanpinCommentbackEntity.setNongchanpinId(Integer.valueOf(data.get(0)));   //畜产品 要改的
