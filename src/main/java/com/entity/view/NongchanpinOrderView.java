	...
	*/
	...
	//级联表 畜产品
		...
		*/
		...
		@ColumnInfo(comment="畜产品名称",type="varchar(200)")
		private String nongchanpinName;
		/**
		* 畜产品照片
		*/

		@ColumnInfo(comment="畜产品照片",type="varchar(200)")
		private String nongchanpinPhoto;
		/**
		* 畜产品类型
		*/
		@ColumnInfo(comment="畜产品类型",type="int(11)")
		private Integer nongchanpinTypes;
			/**
			* 畜产品类型的值
			*/
			@ColumnInfo(comment="畜产品类型的字典表值",type="varchar(200)")
			private String nongchanpinValue;
		/**
		* 畜产品库存
		*/

		@ColumnInfo(comment="畜产品库存",type="int(11)")
		private Integer nongchanpinKucunNumber;
		/**
		* 畜产品原价
		*/
		@ColumnInfo(comment="畜产品原价",type="decimal(10,2)")
		...
		*/
		...
		@ColumnInfo(comment="畜产品介绍",type="text")
