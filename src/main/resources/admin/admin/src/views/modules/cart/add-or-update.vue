        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='nongchanpin'">
                    <el-form-item class="select" v-if="type!='info'"  label="畜产品" prop="nongchanpinId">
                        <el-select v-model="ruleForm.nongchanpinId" :disabled="ro.nongchanpinId" filterable placeholder="请选择畜产品" @change="nongchanpinChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="畜产品名称" prop="nongchanpinName">
                        <el-input v-model="nongchanpinForm.nongchanpinName"
                                  placeholder="畜产品名称" clearable readonly></el-input>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="畜产品类型" prop="nongchanpinValue">
                        <el-input v-model="nongchanpinForm.nongchanpinValue"
                                  placeholder="畜产品类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="畜产品库存" prop="nongchanpinKucunNumber">
                        <el-input v-model="nongchanpinForm.nongchanpinKucunNumber"
                                  placeholder="畜产品库存" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="畜产品原价" prop="nongchanpinOldMoney">
                        <el-input v-model="nongchanpinForm.nongchanpinOldMoney"
                                  placeholder="畜产品原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   nongchanpinId: [
                              { required: true, message: '畜产品不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
