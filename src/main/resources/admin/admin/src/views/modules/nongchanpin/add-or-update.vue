    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="畜产品名称" prop="nongchanpinName">
                       <el-input v-model="ruleForm.nongchanpinName"
                                 placeholder="畜产品名称" clearable  :readonly="ro.nongchanpinName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="畜产品名称" prop="nongchanpinName">
                           <el-input v-model="ruleForm.nongchanpinName"
                                     placeholder="畜产品名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.nongchanpinPhoto" label="畜产品照片" prop="nongchanpinPhoto">
                        <file-upload
                            tip="点击上传畜产品照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.nongchanpinPhoto" label="畜产品照片" prop="nongchanpinPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="畜产品类型" prop="nongchanpinTypes">
                        <el-select v-model="ruleForm.nongchanpinTypes" :disabled="ro.nongchanpinTypes" placeholder="请选择畜产品类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="畜产品类型" prop="nongchanpinValue">
                        <el-input v-model="ruleForm.nongchanpinValue"
                            placeholder="畜产品类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="畜产品库存" prop="nongchanpinKucunNumber">
                       <el-input v-model="ruleForm.nongchanpinKucunNumber"
                                 placeholder="畜产品库存" clearable  :readonly="ro.nongchanpinKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="畜产品库存" prop="nongchanpinKucunNumber">
                           <el-input v-model="ruleForm.nongchanpinKucunNumber"
                                     placeholder="畜产品库存" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="畜产品原价" prop="nongchanpinOldMoney">
                       <el-input v-model="ruleForm.nongchanpinOldMoney"
                                 placeholder="畜产品原价" clearable  :readonly="ro.nongchanpinOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="畜产品原价" prop="nongchanpinOldMoney">
                           <el-input v-model="ruleForm.nongchanpinOldMoney"
                                     placeholder="畜产品原价" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.nongchanpinContent"  label="畜产品介绍" prop="nongchanpinContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.nongchanpinContent" label="畜产品介绍" prop="nongchanpinContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   nongchanpinName: [
                              { required: true, message: '畜产品名称不能为空', trigger: 'blur' },
                          ],
                   nongchanpinPhoto: [
                              { required: true, message: '畜产品照片不能为空', trigger: 'blur' },
                          ],
                   nongchanpinTypes: [
                              { required: true, message: '畜产品类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   nongchanpinKucunNumber: [
                              { required: true, message: '畜产品库存不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   nongchanpinOldMoney: [
                              { required: true, message: '畜产品原价不能为空', trigger: 'blur' },
                   ...
                   nongchanpinContent: [
                              { required: true, message: '畜产品介绍不能为空', trigger: 'blur' },
                          ],
                   shangxiaTypes: [
