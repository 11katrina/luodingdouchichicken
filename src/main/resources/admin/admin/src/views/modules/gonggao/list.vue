        ...
        >
          <el-form-item :label="contents.inputTitle == 1 ? '公告名称' : ''">
            <el-input
              ...
              v-model="searchForm.gonggaoName"
              placeholder="公告名称"
              clearable
            ></el-input>
          </el-form-item>
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '公告类型' : ''">
            <el-select
              v-model="searchForm.gonggaoTypes"
              placeholder="请选择公告类型"
            >
        ...
        >
          <el-form-item>
            ...
            <a
              ...
              href="http://localhost:8080/luodingchicken/upload/gonggaoMuBan.xls"
              >批量导入公告信息数据模板</a
            >
            &nbsp;
            <el-upload
  ...
  methods: {
    ...
    getDataList() {
      ...
      if (
        ...
        this.searchForm.gonggaoName != undefined
      ) {
        params["gonggaoName"] = "%" + this.searchForm.gonggaoName + "%";
      }

      if (
        this.searchForm.gonggaoTypes != "" &&
        this.searchForm.gonggaoTypes != undefined
      ) {
