        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '畜产品名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.nongchanpinName" placeholder="畜产品名称" clearable></el-input>
                     </el-form-item>
                 
                     <el-form-item :label="contents.inputTitle == 1 ? '畜产品类型' : ''">
                        <el-select v-model="searchForm.nongchanpinTypes" placeholder="请选择畜产品类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/luodingchicken/upload/nongchanpinMuBan.xls"
                        >批量导入畜产品数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('nongchanpin','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <!--<el-button v-if="isAuth('nongchanpin','修改')" type="primary" icon="el-icon-add-location" size="mini" @click="plusNongchanpinKucunNumber(scope.row.id,scope.row.nongchanpinKucunNumber)">增加畜产品库存</el-button>-->
                            <!--<el-button v-if="isAuth('nongchanpin','修改')" type="primary" icon="el-icon-delete-location" size="mini" @click="reduceNongchanpinKucunNumber(scope.row.id,scope.row.nongchanpinKucunNumber)">减少畜产品库存</el-button>-->
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '现有余额': 'newMoney',
                //本表字段
                     '畜产品名称': "nongchanpinName",
                     '畜产品照片': "nongchanpinPhoto",
                     '畜产品类型': "nongchanpinValue",
                     '畜产品库存': "nongchanpinKucunNumber",
                     '畜产品原价': "nongchanpinOldMoney",
        ...
        methods: {
			...
			//数据不为空放值
				...
				//标题
				this.nongchanpinKucunNumberTitle = '增加畜产品库存'
			},
			//减少畜产品库存
			...
			//数据不为空放值
				...
				this.nongchanpinKucunNumberVisible = true;
				//标题
				this.nongchanpinKucunNumberTitle = '减少畜产品库存'
			},
			//提交用户操作畜产品库存数量
			addNongchanpinKucunNumber(){
				...
				if(this.kucunNumberTypes == "+"){
					...
					if(this.nongchanpinKucunNumber < this.kucunNumber || this.kucunNumber <= 0){
						this.$message.error('畜产品库存不足不能减少');
						return false;
					}else{
						maxNumber = this.nongchanpinKucunNumber - this.kucunNumber
					}
